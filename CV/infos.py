...
experiences = {
    ...
    'relation': [
        ...
        "Il fait preuve d'empathie et sa determination à aller jusqu'au bout de ses initiatives font de "
        "lui un équipier fiable et agréable"
    ],
               }

formation = {
    'formation': [
        "Stan a toujours été passioné de technologie du web, curieux et autodidacte il a choisi "
        "d'intégrer l'école Openclassroom et suivi un parcours diplomant de "
        "Développeur d'Applications Web Python.<br>"
        "Il validé cette formation et décroché un Titre RCNP niveau BAC+3/4 en octobre 2020"
    ],
             }

projets = {
    'comparateur': [
        "Comme projet de fin d'étude Stan à développé pour son client (une société spécialisé dans la "
        "vente d'éléctroménager) une application Django possédant deux scrappers, qui recupère et "
